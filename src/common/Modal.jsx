    ...
    open && (
      ...
      >
        <div
          ...
          className=" fixed top-1/2 left-1/2 -translate-x-1/2 md:-translate-y-1/2 -translate-y-1/2 rounded-lg bg-white p-4 shadow-lg transition-all duration-500 ease-out w-[calc(100vw-2rem)] md:max-w-lg max-h-[calc(100vh-2rem)] overflow-y-auto"
        >
