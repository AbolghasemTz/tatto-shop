...
function RoadPageDescktop({product}) {
  return (
    <div className="hidden md:block col-span-8 lg:col-span-10 xl:col-span-10">
    <div className="bg-white px-4 rounded-lg flex items-center gap-x-2 py-4">
      ...
      <span className="text-orange-500 text-lg">{product.brand}</span>
      <span>
        <svg
          width="7"
          height="10"
      ...
      <span className="text-gray-500 text-lg">{product.title}</span>
    </div>
  </div>
  )
}

export default RoadPageDescktop
